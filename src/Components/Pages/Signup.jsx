...
export default function Signin(){
    ...
    const validate = (values) => {
        ...
        if (values.txtName.length < 6)
        {
            errors.txtName = "Full name is too short";
        }
        ...
        <div className="signin-container">
            ...
            <div className="signin-section">
                ...
                <div className="form-box">
                    ...
                    <input type="text" placeholder="Enter your full name" name="txtName" className="FieldsStyle" required maxLength={30} onChange={handleChange}></input>
                    <p className="ErrorMessage">{formErrors.txtName}</p>
                ...
                <button className="ButtonStyle" role="button">Sign Up</button>
